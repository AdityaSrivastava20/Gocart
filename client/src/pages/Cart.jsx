...
const Cart = () => {
    const { products, currency, cartItems, setCartItems, removeFromCart, getCartCount, updateCartItem, getCartAmount, navigate, axios, user } = useAppContext();
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        <p className="text-gray-500">{selectedAddress ? `${selectedAddress?.street || 'N/A'}, ${selectedAddress?.city || 'N/A'}, ${selectedAddress?.state || 'N/A'}, ${selectedAddress?.country || 'N/A'}` : "No address found"}</p>
